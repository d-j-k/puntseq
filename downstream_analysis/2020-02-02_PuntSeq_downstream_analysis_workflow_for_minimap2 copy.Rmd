...
```
#### Extra: Main Figure (Overlay of Relative abundance plots from Downsampled data with full dataset)
```{r}
...
gaillardet <- read.table('../results/2019-06-12_Ionics/Gaillardet_1999_Table1.txt', header = T,
...
puntseq <- read_xlsx('../results/2019-08-09_manuscript//Tables/Table_S1.xlsx', sheet = 2, skip = 3)[,-c(2,4:6)]
...
## Fig. S3e
pdf('../results/2019-06-12_Ionics/2020-01-19_Carbonation_world_rivers_S3e.pdf', width = 11, height = 7)
transp <- 0.7
par(mar = c(7,9,2,2))
...
## Month-by-month
pdf('../results/2019-06-12_Ionics/2020-01-19_Carbonation_world_rivers_individual_months.pdf', width = 14, height = 8)
transp <- 0.7
par(mar = c(6,5,5,2))
...
```{r}
############ Taxonomic classifier comparison #############
##################### Version 1.0 ########################
...
tool.performance <- as.matrix(read_xlsx('./Fig_S1_b_table.xlsx', sheet = 1))
...
pdf('./2020-01-26_FigS1b.pdf', width = 7, height = 6)
